# Copilot Instructions — rtsp-to-onvif
...
- `.dockerignore` excludes release-please files + CHANGELOG/README/LICENSE/`test/`/`AGENTS.md`; keep these excludes in sync when adding release-engineering files.
